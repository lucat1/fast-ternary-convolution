...
InfraParameters::InfraParameters(uint32_t num_channels, size_t batch_size,
    ...
    : num_channels(num_channels), batch_size(batch_size),
      ...
      kernel_number(kernel_number), kernel_height(kernel_height),
      kernel_width(kernel_width), padding_size(padding_size),
