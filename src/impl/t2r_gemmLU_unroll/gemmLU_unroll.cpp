#include "impl/t2r_gemmLU_unroll/gemmLU_unroll.hpp"
#include "common.hpp"
...
do {                                                                                            \
  ...
  int load44 = (0);                                                                             \
  size_t iK = (0);                                                                              \
  for(; (((int) (K))) <= (((((int) (K))) - (((int) (((8) * (BITS))))))); iK += ((8) * (BITS)))  \
  {                                                                                             \
                                                                                                \
                                                                                                \
    int64_t load3 = ((activation)[((((iM) * (K))) + (((((iK) + (((0) * (BITS))))) + (0))))]);   \
    int64_t load4 = ((kernel)[((((iN) * (K))) + (((((iK) + (((0) * (BITS))))) + (0))))]);       \
    int64_t load5 = ((activation)[((((iM) * (K))) + (((((iK) + (((0) * (BITS))))) + (1))))]);   \
    int64_t load6 = ((kernel)[((((iN) * (K))) + (((((iK) + (((0) * (BITS))))) + (1))))]);       \
    int64_t load9 = ((activation)[((((iM) * (K))) + (((((iK) + (((1) * (BITS))))) + (0))))]);   \
    int64_t load10 = ((kernel)[((((iN) * (K))) + (((((iK) + (((1) * (BITS))))) + (0))))]);      \
    int64_t load11 = ((activation)[((((iM) * (K))) + (((((iK) + (((1) * (BITS))))) + (1))))]);  \
    int64_t load12 = ((kernel)[((((iN) * (K))) + (((((iK) + (((1) * (BITS))))) + (1))))]);      \
    int64_t load15 = ((activation)[((((iM) * (K))) + (((((iK) + (((2) * (BITS))))) + (0))))]);  \
    int64_t load16 = ((kernel)[((((iN) * (K))) + (((((iK) + (((2) * (BITS))))) + (0))))]);      \
    int64_t load17 = ((activation)[((((iM) * (K))) + (((((iK) + (((2) * (BITS))))) + (1))))]);  \
    int64_t load18 = ((kernel)[((((iN) * (K))) + (((((iK) + (((2) * (BITS))))) + (1))))]);      \
    int64_t load21 = ((activation)[((((iM) * (K))) + (((((iK) + (((3) * (BITS))))) + (0))))]);  \
    int64_t load22 = ((kernel)[((((iN) * (K))) + (((((iK) + (((3) * (BITS))))) + (0))))]);      \
    int64_t load23 = ((activation)[((((iM) * (K))) + (((((iK) + (((3) * (BITS))))) + (1))))]);  \
    int64_t load24 = ((kernel)[((((iN) * (K))) + (((((iK) + (((3) * (BITS))))) + (1))))]);      \
    int64_t load27 = ((activation)[((((iM) * (K))) + (((((iK) + (((4) * (BITS))))) + (0))))]);  \
    int64_t load28 = ((kernel)[((((iN) * (K))) + (((((iK) + (((4) * (BITS))))) + (0))))]);      \
    int64_t load29 = ((activation)[((((iM) * (K))) + (((((iK) + (((4) * (BITS))))) + (1))))]);  \
    int64_t load30 = ((kernel)[((((iN) * (K))) + (((((iK) + (((4) * (BITS))))) + (1))))]);      \
    int64_t load33 = ((activation)[((((iM) * (K))) + (((((iK) + (((5) * (BITS))))) + (0))))]);  \
    int64_t load34 = ((kernel)[((((iN) * (K))) + (((((iK) + (((5) * (BITS))))) + (0))))]);      \
    int64_t load35 = ((activation)[((((iM) * (K))) + (((((iK) + (((5) * (BITS))))) + (1))))]);  \
    int64_t load36 = ((kernel)[((((iN) * (K))) + (((((iK) + (((5) * (BITS))))) + (1))))]);      \
    int64_t load39 = ((activation)[((((iM) * (K))) + (((((iK) + (((6) * (BITS))))) + (0))))]);  \
    int64_t load40 = ((kernel)[((((iN) * (K))) + (((((iK) + (((6) * (BITS))))) + (0))))]);      \
    int64_t load41 = ((activation)[((((iM) * (K))) + (((((iK) + (((6) * (BITS))))) + (1))))]);  \
    int64_t load42 = ((kernel)[((((iN) * (K))) + (((((iK) + (((6) * (BITS))))) + (1))))]);      \
    int64_t load45 = ((activation)[((((iM) * (K))) + (((((iK) + (((7) * (BITS))))) + (0))))]);  \
    int64_t load46 = ((kernel)[((((iN) * (K))) + (((((iK) + (((7) * (BITS))))) + (0))))]);      \
    int64_t load47 = ((activation)[((((iM) * (K))) + (((((iK) + (((7) * (BITS))))) + (1))))]);  \
    int64_t load48 = ((kernel)[((((iN) * (K))) + (((((iK) + (((7) * (BITS))))) + (1))))]);      \
                                                                                                \
...
Tensor4D<float> gemmLU_unroll(const Tensor7D<int64_t> &activation,
  ...
  for (; (int)im <= (int)M - (int)M_block_size; im += M_block_size) {
    for (size_t imb = 0; imb < M_block_size; imb++) {
	  ...
	  gemm_kernel(activation_data, kernel_data, output_data, N, K, BITS, im + imb, in + inb, alpha);
        }
      }
      // handle leftovers of N
      for (; in < N; in++) {
        // Use the PROCESS_BLOCKS macro for leftover N processing
	gemm_kernel(activation_data, kernel_data, output_data, N, K, BITS, im + imb, in, alpha);
      }
    }
  }
  ...
  for (; im < M; im++) {
    ...
    for (; (int)in <= (int)N - (int)N_block_size; in += N_block_size) {
      for (size_t inb = 0; inb < N_block_size; inb++) {
	gemm_kernel(activation_data, kernel_data, output_data, N, K, BITS, im, in + inb, alpha);
      }
    }
    for (; in < N; in++) {
      gemm_kernel(activation_data, kernel_data, output_data, N, K, BITS, im, in, alpha);
    }
  }
