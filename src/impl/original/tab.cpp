...
#include "common.hpp"
#include "impl/original/activation.hpp"
#include "impl/original/gemm.hpp"
#include "impl/original/im2row.hpp"
#include "impl/original/quantize.hpp"
#include "measure.hpp"
...
Tensor4D<float> conv(const Tensor4D<float> &_input,
  ...
  auto prelu_res = PReLU(yi.data(), Batch_Size, KN, OH, OW, ReLU_alpha);
