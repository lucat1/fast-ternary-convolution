#include "minor_impls/avx2/gemm_avx2_autogen.hpp"
#include "common.hpp"
#include <immintrin.h>
...
#define gemm_kernel_256(activation, kernel, K, iM, iN, output, alpha, N)       \
  do {                                                                         \
    ...
    for (; (((int)(iK))) <=                                                    \
      ...
      load12 = (_mm256_loadu_si256(                                            \
          (__m256i *)(kernel +                                                 \
                      (((((iN) * (K))) +                                       \
                        (((((iK) + (((1) * (((4) * (BITS))))))) + (4))))))));  \
                                                                               \
      comp1 = (_mm256_unpacklo_epi64(load3, load5));                           \
      comp2 = (_mm256_unpackhi_epi64(load3, load5));                           \
      comp3 = (_mm256_unpacklo_epi64(load4, load6));                           \
      comp4 = (_mm256_unpackhi_epi64(load4, load6));                           \
      ...
      comp10 = (((load1) + (comp8)));                                          \
      comp11 = (((load2) + (comp9)));                                          \
      comp12 = (_mm256_unpacklo_epi64(load9, load11));                         \
      comp13 = (_mm256_unpackhi_epi64(load9, load11));                         \
      comp14 = (_mm256_unpacklo_epi64(load10, load12));                        \
      comp15 = (_mm256_unpackhi_epi64(load10, load12));                        \
      comp16 = (_mm256_xor_si256(comp12, comp14));                             \
      comp17 = (_mm256_and_si256(comp13, comp15));                             \
