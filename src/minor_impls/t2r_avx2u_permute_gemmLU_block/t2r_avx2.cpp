#include "minor_impls/t2r_avx2u_permute_gemmLU_block/t2r_avx2.hpp"
#include "common.hpp"
#include "tensor.hpp"
  ...
  {                                                                            \
    ...
    __m256i second_bits_ored_perm_ored =                                       \
        _mm256_or_si256(second_bits_ored, second_bits_ored_perm);              \
                                                                               \
    int64_t first_bits0 = _mm256_extract_epi64(first_bits_ored_perm_ored, 0);  \
    int64_t first_bits1 = _mm256_extract_epi64(first_bits_ored_perm_ored, 2);  \
    int64_t second_bits0 =                                                     \
        _mm256_extract_epi64(second_bits_ored_perm_ored, 0);                   \
    int64_t second_bits1 =                                                     \
