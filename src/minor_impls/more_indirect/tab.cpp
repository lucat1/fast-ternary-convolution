...
#include "main_impls/data_order_nhwc/quantize.hpp"
#include "measure.hpp"
#include "minor_impls/more_indirect/gemm.hpp"
...
Tensor4D<float> conv(const Tensor4D<float> &input,
  ...
  Tensor5D<int64_t> quantized =
      data_order_nhwc::ternarize(input, thresholds, padding_h, padding_w);
